    ...
    <>
      <Box sx={{ width: '100%', maxWidth: 500, marginBottom: 4 }}>
        ...
        <Typography variant='body1'>
          Grab your friends and family, and play games over zoom together. We aim to make every game customizable to your language.
          Unlike over game sites, will will not have ads.
        </Typography>
      </Box>
      <GameCards />
    </>
